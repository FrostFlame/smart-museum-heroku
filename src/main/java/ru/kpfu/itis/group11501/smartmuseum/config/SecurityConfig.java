...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/admin/**","/profile/{\\d+}/edit","/playing_schedule/{\\d+}/add","/playing_schedule/{\\d+}/delete","/user_statistic**").hasRole("ADMIN")
                .antMatchers("/profile/edit").hasAnyRole("MANAGER", "NORMAL", "ADMIN")
                .antMatchers("/videos/*","/projector/{\\d+}/deleteVideo","/projector/{\\d+}/modifyVideo").hasAnyRole("MANAGER",  "ADMIN")
                .and()
                    .rememberMe()
                .and()
                    .logout()
