...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/admin/**","/profile/{\\d+}/edit","/playing_schedule/{exposition_id}/add","/playing_schedule/{exposition_id}/delete","/user_statistic**").hasRole("ADMIN")
                .antMatchers("/profile/edit").hasAnyRole("MANAGER", "NORMAL", "ADMIN")
                .antMatchers("/videos/*","/projector/*/deleteVideo","/projector/*/modifyVideo").hasAnyRole("MANAGER",  "ADMIN")
        ...
        http.csrf().disable()
                ...
                .defaultSuccessUrl("/playing_schedule", true)
