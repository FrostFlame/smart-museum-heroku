    ...
    <div class="row">
        ...
        <div class="col-xs-10 col-md-9">
            <ul class="nav nav-tabs">
                ...
                <li><a href="#"><span class="glyphicon glyphicon-th"></span> Экспозиции</a></li>
                <li><a href="#"><span class="glyphicon glyphicon-film"></span> Видео</a></li>
                <li><a href="#"><span class="glyphicon glyphicon-blackboard"></span> Проекторы</a></li>
                <li><a href="#"><span class="glyphicon glyphicon-list-alt"></span> Пользователи</a></li>
